// andrewm@isoar.ca (Andrew E. Mileski)
// http://www.netwinder.org/pipermail-netwinder/devel/2002-January/000147.html
// [devel] Re: Fixed point math
//
// Andrew E. Mileski andrewm@isoar.ca
// Sun, 20 Jan 2002 12:15:59 -0500
// ...
// "Andrew E. Mileski" wrote:
// >
// > ftp://ftp.isoar.ca/users/a/andrewm/math/math-sll.c
//
// Added a square root routine sllsqrt(), and verbosely
// documented how I developed the algorithm.
//
// I've put the source under CVS control, so the ID for this
// version is 1.2 (as there is only 1 file I don't see the
// point of tagging it with a release), and is clearly
// displayed at the top of the file.
//
// I changed the license from the original GPL to the more
// appropriate LGPL.
//
// --
// Andrew E. Mileski
